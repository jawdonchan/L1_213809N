...
import 'package:SnapUp_Project/widgets/AddReview.dart';
          ...
          actions: <Widget>[
            IconButton(
                ...
                onPressed: () {
                  ...
                  numberOfRating:  widget.detail.numberOfRating,
                  price: widget.detail.price,
                  slug: widget.detail.slug,) //FoodOrderPage() 
                  ));
                })
          ],
        ),
            ...
            child: Column(
              ...
              children: <Widget>[
                Card(
                  ...
                  child: Image.asset(
                    'images/' + widget.detail.imageUrl + ".png",
                  ),
                ...
                FoodTitleWidget(
                    ...
                    productPrice: widget.detail.price,
...
class ReviewContentMenu extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
  return Container(
  child: ListView.builder(
  itemCount: existingReviews.length,
  ...
  children: <Widget>[
  Text(
  existingReviews[index].userName,
  style: TextStyle(
  ...
  child: Text(
  existingReviews[index].reviewText,
  style: TextStyle(
  fontSize: 14.0,
  color: Colors.black87,
  fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text(
                    'Rating: ${existingReviews[index].rating}',
                    style: TextStyle(
                      fontSize: 14.0,
                      color: Colors.black87,
                    ),
            ...
            Container(
                    ...
                    child: Text(
                      'Date: ${existingReviews[index].reviewDate.toString()}',
                      style: TextStyle(
                        fontSize: 14.0,
                        color: Colors.black87,
                      ),
